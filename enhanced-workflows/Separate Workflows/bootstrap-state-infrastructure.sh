...
# Step 4: Generate GitHub secrets configuration
echo -e "${BLUE}📋 Step 4: Generating GitHub secrets configuration${NC}"
echo -e "${GREEN}🎉 State infrastructure bootstrap complete!${NC}"
echo -e "${BLUE}================================================${NC}"
echo -e "${YELLOW}📝 Next steps:${NC}"
echo -e "${YELLOW}1. Configure the following GitHub secrets in your repositories:${NC}"
echo ""
echo -e "${BLUE}Platform Repository (alz-platform) secrets:${NC}"
...
echo ""
echo -e "${BLUE}Subscription Repository secrets:${NC}"
for sub in "${SUBSCRIPTIONS[@]}"; do
    STORAGE_NAME="stalz${sub}state"
...
echo -e "${YELLOW}2. Test your workflows with manual triggers${NC}"
echo -e "${YELLOW}3. Verify state files are created correctly${NC}"
echo ""
