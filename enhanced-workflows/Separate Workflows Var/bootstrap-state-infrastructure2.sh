...
echo "📋 Next Steps:"
echo "1. Copy the GitHub Variables below to your repositories"
echo "2. Copy the GitHub Secrets below to your repositories"
echo "3. Test your workflows"
echo ""

echo "🔑 GitHub Variables to Configure (Repository Settings → Variables):"
echo ""
...
echo "🔐 GitHub Secrets to Configure (Repository Settings → Secrets):"
echo ""
echo "All repositories need these secrets:"
...
echo ""
echo "💡 Remember:"
echo "  - Variables = Non-sensitive configuration (visible in logs)"
echo "  - Secrets = Sensitive data (encrypted, hidden in logs)"
